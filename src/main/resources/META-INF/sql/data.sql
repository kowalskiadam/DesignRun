...
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("bieg spokojny", "easy run", "BS", 5, 15, 1)
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("wybieganie", "the long one", "Long", 15, 32, 1)
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("tempo progowe", "hard stuff", "Tempo", 10, 20, 1)
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("przebieżka", "short and easy","BS", 5, 15, 2)
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("wybieganie","very long", "Long", 15, 25, 2)
insert into training_types (name, description, shortCut, minDistance, maxDistance, method_id) values ("zabawa biegowa","run fast for fun" ,"Zabawa", 8, 16, 2)
